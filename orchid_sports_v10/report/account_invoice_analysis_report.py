...
class AccountInvoiceAnalysisReport(models.Model):
	_name = "od.account.move.analysis.report"
	_description = "Invoices Analysis"
	_auto = False
	_rec_name = 'date'
	...
	od_grand_total = fields.Float(string='Total With Tax', readonly=True)
	...
	od_invoice_id = fields.Many2one('account.move', string='Invoice', readonly=True)
	...
	# def _select(self):
	# 	select_str = """
	# 		SELECT sub.id, sub.date,sub.od_invoice_id, sub.product_id, sub.partner_id, sub.country_id, sub.account_analytic_id,
	# 			sub.payment_term_id, sub.uom_name, sub.currency_id, sub.journal_id,
	# 			sub.fiscal_position_id, sub.user_id, sub.company_id, sub.nbr, sub.type, sub.state,
	# 			sub.weight, sub.volume,
	# 			sub.categ_id, sub.date_due, sub.account_id, sub.account_line_id, sub.partner_bank_id,
	# 			sub.product_qty,sub.od_grand_total as od_grand_total, sub.price_total as price_total, sub.price_average as price_average,
	...
	# 				SUM(ail.od_net_amount) AS od_grand_total,
